...
There is a class for each namespace, and for each outputformat with tables that map strings to class. 
...
with edits to match current names etc in Microservices below.
